...
class PropertyTest < Minitest::Test
  ...
  def test_single_category_returns_as_array
    prop = Property.new("TEXT", single_value: false, only_once: false)
    value = "MEETING"
  ...
  def test_parses_geo
    prop = Property.new("FLOAT", parts: ["lat", "lon"])
  ...
  def test_parses_request_status
    prop = Property.new("TEXT", only_once: false)
  ...
  def test_parse_alternate_type
    prop = Property.new("DATE-TIME", alt_values: ["DATE", "PERIOD"], single_value: false, only_once: false)
