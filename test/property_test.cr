...
class PropertyTest < Minitest::Test
  ...
  def test_initializes
    prop = { name: "contact", key: "contacts", "only_once": false }
    contact_prop = Property.new(prop)
  ...
  def test_derives_list_from_component_property
    category_prop = Property.new({ name: "categories", only_once: false })
  ...
  def test_single_category_returns_as_array
    prop = Property.new({ name: "categories", only_once: false })
    value = "MEETING"
  ...
  def test_parses_geo
    prop = Property.new({ name: "geo", parts: ["lat", "lon"] })
  ...
  def test_property_parses_params_with_array_value
    prop = Property.new({ name: "attendee" })
  ...
  def test_parses_request_status
    prop = Property.new({ name: "request_status", only_once: false })
  ...
  def test_parse_alternate_type
    prop = Property.new({ name: "exdate", only_once: false })
  ...
  def test_raises_for_no_name
    error = assert_raises do
      Property.new({ prop: "uid" })
    end
    assert_equal "Property Error: Property must have a name", error.message
  end
end
