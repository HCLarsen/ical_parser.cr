...
class PropertyTest < Minitest::Test
  ...
  def test_property_parses_value_with_params
    prop = Property.new(@@caladdress_parser)
  ...
  def test_single_category_returns_as_array
    prop = Property.new(@@text_parser, single_value: false, only_once: false)
    value = "MEETING"
  ...
  def test_parses_geo
    prop = Property.new(@@float_parser, parts: ["lat", "lon"])
