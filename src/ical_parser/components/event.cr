...
module IcalParser
  class Event
    PROPERTIES = {
      ...
      "class"           => Property.new("class"),
      "categories"      => Property.new("categories", single_value: false, only_once: false),
      "resources"       => Property.new("resources", single_value: false, only_once: false),
      "contacts"        => Property.new("contact", single_value: false, only_once: false),
      "related_to"      => Property.new("related_to", single_value: false, only_once: false),
      "request-status"  => Property.new("request_status", only_once: false),
      "transp"          => Property.new("transp"),
      "status"          => Property.new("status"),
      "comments"        => Property.new("comment"),
      ...
      "attendees"       => Property.new("attendee", only_once: false),
      "geo"             => Property.new("geo", parts: ["lat", "lon"]),
      "rrule"           => Property.new("rrule"),
      "exdate"          => Property.new("exdate", single_value: false, only_once: false),
      "rdate"           => Property.new("rdate", single_value: false, only_once: false),
    ...
    JSON.mapping(
      ...
      last_modified: {type: Time?, key: "last-modified", converter: Time::ISO8601Converter},
