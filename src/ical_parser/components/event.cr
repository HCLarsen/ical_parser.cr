...
module IcalParser
  class Event
    PROPERTIES = {
      ...
      "last-modified"   => Property.new(["DATE-TIME"]),
      "dtstart"         => Property.new(["DATE-TIME", "DATE"]),
      "dtend"           => Property.new(["DATE-TIME", "DATE"]),
      "duration"        => Property.new(["DURATION"]),
      "summary"         => Property.new(["TEXT"]),
      "description"     => Property.new(["TEXT"]),
      "class"           => Property.new(["TEXT"]),
      ...
      "rrule"           => Property.new(["RECUR"]),
      "exdate"          => Property.new(["DATE-TIME", "DATE"], single_value: false, only_once: false),
      "rdate"           => Property.new(["DATE-TIME", "DATE", "PERIOD"], single_value: false, only_once: false),
