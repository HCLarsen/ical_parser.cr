module IcalParser
  class EventParser
    ...
    COMPONENT_PROPERTIES = {
      ...
      "dtstart"         => Property(Time).new(PARSERS["DATE-TIME"], alt_values: ["DATE"]),
      "dtend"           => Property(Time).new(PARSERS["DATE-TIME"], alt_values: ["DATE"]),
      "duration"        => Property(Time::Span).new(PARSERS["DURATION"]),
